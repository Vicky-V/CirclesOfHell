...
namespace CirclesOfHell
{
    public static class Easing
    {
        ...
        public static float Ease(double linearStep, float acceleration, EasingType type)
        {
            ...
            return MathHelperEasing.Lerp(linearStep, easedStep, Math.Abs(acceleration));
        }
        ...
        static class Sine
        {
            ...
            {
                return (float)Math.Sin(s * MathHelperEasing.HalfPi - MathHelperEasing.HalfPi) + 1;
            }
            public static float EaseOut(double s)
            {
                return (float)Math.Sin(s * MathHelperEasing.HalfPi);
            }
            public static float EaseInOut(double s)
            {
                return (float)(Math.Sin(s * MathHelperEasing.Pi - MathHelperEasing.HalfPi) + 1) / 2;
            }
        }
    ...
    public static class MathHelperEasing
    {
